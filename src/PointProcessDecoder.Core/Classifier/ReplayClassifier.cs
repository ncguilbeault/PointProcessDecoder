...
namespace PointProcessDecoder.Core.Classifier;

public class ReplayClassifier : ModelComponent, IClassifier
{
    ...
    public ClassifierType ClassifierType => ClassifierType.ReplayClassifier;
    ...
    /// </summary>
    private Tensor _discreteTransitions;

    /// <summary>
    /// The continuous transitions for each state, shape [2, n, n].
    /// </summary>
    private Tensor _continuousTransitions;
    ...
    public ReplayClassifier(
        IStateSpace stateSpace,
        double? sigmaRandomWalk = null,
        double stayProbability = 0.99,
        Device? device = null,
